...
/** Facade principal da API AureEX para Java (crypto only). */
public final class AureEx {
    ...
    public AureEx(String apiKey, String apiSecret) {
        this(apiKey, apiSecret, "https://api.aure-ex.com/v1", 2);
    }

    /** Cria o cliente autenticado com X-Api-Key / X-Api-Secret. */
    public AureEx(String apiKey, String apiSecret, String baseUrl, int maxRetries) {
            ...
            while (true) {
                ...
                try {
                    ...
                    if (status >= 400) {
                        ...
                        throw new AureExException(message, code, details, status);
                    }
                    ...
                    return decoded;
                } catch (AureExException e) {
                    throw e;
                } catch (Exception e) {
                    throw new AureExException(e.getMessage() == null ? "HTTP request failed." : e.getMessage(), null, null, 0);
                }
            }
        }
    }
